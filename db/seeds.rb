...
# Admin.create!(:username => "admin", :password => "password", :password_confirmation => "password", :first_name => "amjad", :middle_name => "sample",
#                   :last_name => "yassin", :email => "yassiadmin@gmail.com", :gender => "male")
