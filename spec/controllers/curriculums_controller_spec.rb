...
RSpec.describe CurriculumsController, type: :controller do
  ...
  describe "POST #create" do
    context "with valid params" do
      ...
      it "renders a JSON response with the new curriculum" do

        post :create, params: {curriculum: valid_attributes}, session: valid_session
        expect(response).to have_http_status(:created)
        expect(response.content_type).to eq('application/json')
        expect(response.location).to eq(curriculum_url(Curriculum.last))
      end
    end

    context "with invalid params" do
      it "renders a JSON response with errors for the new curriculum" do
  ...
  describe "PUT #update" do
    context "with valid params" do
      ...
      it "renders a JSON response with the curriculum" do
        curriculum = Curriculum.create! valid_attributes
    ...
    context "with invalid params" do
      it "renders a JSON response with errors for the curriculum" do
        curriculum = Curriculum.create! valid_attributes
