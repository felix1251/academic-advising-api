...
RSpec.describe MajorsController, type: :controller do
  ...
  describe "GET #show" do
    it "returns a success response" do
      major = Major.create! valid_attributes
      get :show, params: {id: major.to_param}, session: valid_session
      expect(response).to be_successful
    end
  end
  ...
  describe "POST #create" do
    context "with valid params" do
      ...
      it "renders a JSON response with the new major" do

        post :create, params: {major: valid_attributes}, session: valid_session
        expect(response).to have_http_status(:created)
        expect(response.content_type).to eq('application/json')
        expect(response.location).to eq(major_url(Major.last))
      end
    end

    context "with invalid params" do
      it "renders a JSON response with errors for the new major" do
  ...
  describe "PUT #update" do
    context "with valid params" do
      ...
      it "renders a JSON response with the major" do
        major = Major.create! valid_attributes
    ...
    context "with invalid params" do
      it "renders a JSON response with errors for the major" do
        major = Major.create! valid_attributes
